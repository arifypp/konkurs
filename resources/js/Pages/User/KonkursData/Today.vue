    ...
    <AuthenticatedLayout>
        ...
        <a-row type="flex" gutter="16">
            <a-col :span="24" :order="2">
                <a-alert
                    message="গুরুত্বপূর্ণ তথ্যবিবরণী"
                    description="Troms, Finnmark, Trøndelag, Nordland এইগুলো থাকলে ঐ সকল কুনকরস অ্যাড করার প্রয়োজন নেই। এবং কুনকোর্সের কোম্পানির শেষে যদি, AS, LTD থাকে শুধুমাত্র সেগুলো সিলেক্ট করতে হবে, অন্যান্যগুলো নির্বাচন করা যাবে না। "
                    type="info"
